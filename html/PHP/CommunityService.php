...
function RespondCommunityServiceRequest ($link, $data){
  ...
  if ($data['decision'] == 1){
    ...
    $insetCommunityService = "INSERT INTO community_service (total_hours, club_year_id, requester_id) SELECT total_hours, club_year_id, requester_id FROM community_service_request WHERE request_id = " . $data['request_id'];
    //query
