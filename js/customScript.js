...
function addInput(divName){
     if (counter > limit)  {
          ...
          newdiv.innerHTML = "<label id = 'font-style' for='email_id' class='control-label'>Volunteer " +(counter) + "</label>"
          newdiv.innerHTML += "<input type='text' class='form-control' id='between_input' name='vol" + (counter) + "' placeholder='Name of Volunteer " + counter + "'>";

          newdiv.innerHTML += "<input type='text' class='form-control' id='between_input' name='vol" + (counter) + "_hrs' placeholder='Hours Served By Volunteer " + counter +"'>";
...
/*
<div class="row">
    <label id = "font-style" for="email_id" class="control-label">Volunteer 5</label>
    <input type="text" class="form-control" id="between_input" placeholder="Name of Volunteer 5" name="myInputs[]">
</div>
<div class="row">
    <input type="text" class="form-control" id="between_input" placeholder="Hours Served by Volunteer 5" name="myInputs[]">
</div>*/
/*
